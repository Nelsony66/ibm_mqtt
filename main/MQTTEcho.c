...
#define CONFIG_WIFI_SSID "SYN"
#define CONFIG_WIFI_PASSWORD "12345678"


#define CONFIG_MQTT_BROKER "192.168.0.17"
//#define CONFIG_DEFAULT_MQTT_VERSION 2
...
#define CONFIG_MQTT_PASSWORD "public"
...
static void echo_task()
{
    ...
    while (1) {
        ...
        //if (write(ta_sock, data, len) < 0) {
            //   printf("ESP8266 uart task send fail\n");
           //    break;
         //  } 
        // deal_uart_data(data, len);write(s,dataptr,len)
        }
}
